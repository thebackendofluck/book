...
class Bettor:
    def __init__(self, **kwargs):
        ...
        self.bettingprovider_offering_url = kwargs.get("bettingprovider_offering_url")
        self.bettingprovider_player_api = kwargs.get("bettingprovider_player_api")
        self.bettingprovider_offering_id = kwargs.get("bettingprovider_offering_id")
        self.correlation_id = kwargs.get("correlation_id")
        self.bettingprovider_session_id = kwargs.get("bettingprovider_session_id")
        self.pam_user_id = kwargs.get("pam_user_id")
        self.browser_headers = {
            "authority": kwargs.get("bettingprovider_player_api"),
            "pragma": "no-cache",
    ...
    def find_game(self, sport, group):
        url = f"{self.bettingprovider_offering_url}/offering/v2018/{self.bettingprovider_offering_id}/listView/{sport}/all/all/all/matches.json?includeParticipants=true&useCombined=true&lang=en_US&market=US"
        headers = {"X-Corr-Id": self.correlation_id}

        response = self.client.get(
            url, headers=headers, name=f"<bettingprovider>/offerings/{sport}"
        )
    ...
    def validate_betslip(self):
        ...
        with self.client.post(
            f"{self.bettingprovider_player_api}/player/api/v2019/{self.bettingprovider_offering_id}/coupon/validate.json?lang=en_US&market=US",
            headers=self.browser_headers,
            data=json.dumps(request),
            name="<bettingprovider>/coupon/validate",
            catch_response=True,
        ) as response:
    ...
    def place_bet(self):
        ...
        with self.client.post(
            f"{self.bettingprovider_player_api}/player/api/v2019/{self.bettingprovider_offering_id}/coupon.json?lang=en_US&market=US",
            headers={
                "Authorization": f"Bearer {self.bettingprovider_session_id}",
                "X-Corr-Id": self.correlation_id,
                "Content-Type": "application/json",
                "authority": "ctp - auth.bettingprovider-api.acmetocasino.workers.dev",
                "origin": "https://sb-drill.acmetocasino.workers.dev",
                # "referer": "https://sb-drill.acmetocasino.workers.dev/",
