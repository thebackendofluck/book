...
class MockHSMClient:
    ...
    def decrypt(self, key_id: str, ciphertext: bytes, iv: bytes, tag: bytes, algorithm: str) -> bytes:
...
class HSMEncryptionService:
    ...
    async def decrypt_data(
        ...
        try:
            ...
            plaintext = self.hsm_client.decrypt(
                ...
                tag=encrypted_data.tag,  # ty:ignore[invalid-argument-type]
    ...
    def _store_key_metadata(self, key_metadata: EncryptionKey):
        ...
        with self.db_conn.cursor() as cursor:
            ...
            """, (
                ...
                json.dumps(key_metadata.metadata),  # ty:ignore[unresolved-reference]
    ...
    def _cache_encryption_metadata(self, encrypted_data: EncryptedData):
        ...
        self.redis_client.setex(
            cache_key,
            3600,  # 1 hour
            json.dumps(metadata)  # ty:ignore[unresolved-reference]
        )
    ...
    def _audit_log(self, action: str, details: Dict[str, Any]):
        ...
        with self.db_conn.cursor() as cursor:
            ...
            """, (
                ...
                action,
                json.dumps(details),  # ty:ignore[unresolved-reference]
