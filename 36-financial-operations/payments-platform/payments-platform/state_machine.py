...
class PaymentStateMachine:
    ...
    def pending(self, payment: Payment) -> Payment:
        return self.transition(payment, PaymentStatus.PENDING)

    def processing(self, payment: Payment) -> Payment:
