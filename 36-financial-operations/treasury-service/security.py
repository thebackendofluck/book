...
sig = HMAC-SHA256(base64url(json_claims), TREASURY_JWT_SECRET). Claims are
...
SECRET_KEY: str = os.getenv("TREASURY_JWT_SECRET", "")

_bearer_scheme = HTTPBearer(auto_error=False)


class ServiceRole(str, Enum):
    SERVICE = "service"  # trusted internal caller (payments platform, reconciliation jobs)
    ADMIN = "admin"       # backoffice treasury operator
