...
async def record_settlement(body: RecordSettlementRequest) -> dict:
    """
...
async def mark_settled(settlement_id: str) -> dict:
...
async def mark_failed(settlement_id: str, body: MarkFailedRequest) -> dict:
